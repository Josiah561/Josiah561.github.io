 ...
 * All icons are inline SVGs from lucide.dev
 * Usage: icon('book', 'md')  →  returns SVG HTML string
 *        iconEl('search', 'sm')  →  returns jQuery element
 */
...
const Icons = {
  ...
  library: `<svg viewBox="0 0 24 24"><path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/></svg>`,
  ...
  layoutDash: `<svg viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>`,
  ...
  trophy: `<svg viewBox="0 0 24 24"><polyline points="8 6 2 6 2 12 8 12"/><polyline points="16 6 22 6 22 12 16 12"/><path d="M12 17c-2.67 0-8-1.34-8-4V6h16v7c0 2.66-5.33 4-8 4z"/><path d="M12 17v4"/><path d="M8 21h8"/></svg>`,
  ...
  // ── Library specific ──────────────────────────────────────────
  bookMarked: `<svg viewBox="0 0 24 24"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>`,
  bookCopy: `<svg viewBox="0 0 24 24"><path d="M2 16V4a2 2 0 0 1 2-2h11"/><path d="M22 18H11a2 2 0 1 0 0 4h10.5a.5.5 0 0 0 .5-.5v-15a.5.5 0 0 0-.5-.5H11a2 2 0 0 0-2 2v12"/></svg>`,
  returnBook: `<svg viewBox="0 0 24 24"><path d="M9 14 4 9l5-5"/><path d="M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5v0a5.5 5.5 0 0 1-5.5 5.5H11"/></svg>`,
  clipboardList: `<svg viewBox="0 0 24 24"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><line x1="12" y1="11" x2="16" y2="11"/><line x1="12" y1="16" x2="16" y2="16"/><line x1="8" y1="11" x2="8.01" y2="11"/><line x1="8" y1="16" x2="8.01" y2="16"/></svg>`,
  ...
  phone: `<svg viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.42 2 2 0 0 1 3.6 1.26h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.58a16 16 0 0 0 6 6l.54-.54a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 17z"/></svg>`,
  ...
  idCard: `<svg viewBox="0 0 24 24"><rect x="2" y="5" width="20" height="14" rx="2"/><circle cx="8" cy="12" r="2"/><path d="M14 9h4M14 12h4M14 15h2"/></svg>`,
...
/**
 * Returns SVG HTML string for an icon
 * @param {string} name  - key from Icons object
 * @param {string} size  - 'xs'|'sm'|'md'|'lg'|'xl'|'2xl'  (default 'md')
 * @param {string} extra - extra CSS classes
 */
function icon(name, size = 'md', extra = '') {
  const svg = Icons[name];
  if (!svg) return '';
  // Inject class attributes into the SVG tag
  return svg.replace('<svg ', `<svg class="icon icon-${size} icon-stroke ${extra}" `);
}

/**
 * Returns a jQuery-wrapped SVG element
 */
function iconEl(name, size = 'md', extra = '') {
  return $(icon(name, size, extra));
}
